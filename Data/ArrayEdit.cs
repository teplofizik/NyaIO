...
namespace NyaIO.Data
{
    public static class ArrayEdit
    {
        ...
        /// <summary>
        /// Read byte array from position to end of array
        /// </summary>
        /// <param name="Data">Source array</param>
        /// <param name="Offset">Offset from start of data</param>
        /// <returns>Readed array</returns>
        ...
        /// <param name="Data">Source array</param>
        /// <param name="Offset">Offset from start of struct to field</param>
        /// <returns>Readed float value</returns>
        static public float ReadFloat(this byte[] Data, long Offset) => (float)ReadUInt32(Data, Offset);
    }
}
